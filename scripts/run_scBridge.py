...
def main():
        ...
        if args.atac_to_rna:
            ...
            for k_a, v_a in ratk_a2r.items():
                ...
                res.append({
                    ...
                    "cell_type_acc_r2a":ct_acc_r2a,
                    "cell_type_acc_a2r":ct_acc_a2r,
                    "cell_type_ASW":asw,
                    "MedR_a2r":medr_a2r,
                    "MedR_r2a":medr_r2a
                })
    ...
    result.to_csv(os.path.join(args.save_dir, "scBridge_metrics.csv"), index=False)
