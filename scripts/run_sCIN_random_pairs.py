from sCIN.sCIN_random_pairs import train_sCIN_ablated, get_emb_sCIN_ablated
...
def main() -> None:
    ...
    for i, seed in enumerate(seeds):
        ...
        train_dict = train_sCIN_ablated(rna_train, 
                                        atac_train,
                                        labels_train, 
                                        settings=sCIN,
        ...
        rna_embs, atac_embs = get_emb_sCIN_ablated(rna_test, 
                                                   atac_test,
    ...
    results.to_csv(os.path.join(res_save_dir, f"metrics_sCIN_random_pairs{args.num_reps}reps.csv"), index=False)
