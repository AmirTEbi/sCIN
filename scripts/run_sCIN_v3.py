from sCIN.sCIN_v3 import train_sCIN_v3, get_emb_sCIN_v3
from configs import sCIN_v3
...
def main() -> None:
    ...
    for i, seed in enumerate(seeds):
        ...
        train_dict = train_sCIN_v3(rna_train, 
                                   atac_train,
                                   labels_train, 
                                   settings=sCIN_v3,
        ...
        rna_embs, atac_embs = get_emb_sCIN_v3(rna_test, 
                                              atac_test,
